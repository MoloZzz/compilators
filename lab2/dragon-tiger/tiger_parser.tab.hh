  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ifThenExpr = 61,                       // ifThenExpr
        S_ifThenElseExpr = 62,                   // ifThenElseExpr
        S_exprs = 63,                            // exprs
        S_nonemptyexprs = 64,                    // nonemptyexprs
        S_arguments = 65,                        // arguments
        S_nonemptyarguments = 66,                // nonemptyarguments
        S_params = 67,                           // params
        S_nonemptyparams = 68,                   // nonemptyparams
        S_decls = 69,                            // decls
        S_param = 70,                            // param
        S_typeannotation = 71                    // typeannotation
      };
    };
